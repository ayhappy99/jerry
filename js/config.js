...
export const POUCH = {
  ...
  // 잭팟 몫을 2.94%에서 6.00%로 올린 만큼 덩어리 몫이 91.95%에서 89.00%로 내려왔다.
  // 배당표 전체에 배율을 걸고 보기 좋은 값으로 스냅한 뒤, 개별 배당을 한 칸씩
  // 움직이는 그리디로 89.00%에 맞췄다(사다리 단조성은 검사로 지킨다).
  pays: {
    yeopjeon: { 5: 0.6, 6: 1.2, 7: 1.8, 8: 2.5, 9: 4, 10: 6, 12: 12 },
    maedeup: { 5: 1, 6: 2, 7: 3, 8: 5, 9: 8, 10: 10, 12: 25 },
    moran: { 5: 1.5, 6: 2.5, 7: 4, 8: 6, 9: 10, 10: 12, 12: 30 },
    cheongja: { 5: 1.8, 6: 3, 7: 5, 8: 8, 9: 12, 10: 18, 12: 40 },
    crane: { 5: 3, 6: 5, 7: 8, 8: 12, 9: 15, 10: 25, 12: 80 },
    toad: { 5: 4, 6: 8, 7: 12, 8: 18, 9: 30, 10: 50, 12: 80 },
    tiger: { 5: 6, 6: 12, 7: 18, 8: 25, 9: 40, 10: 50, 12: 150 },
  },
